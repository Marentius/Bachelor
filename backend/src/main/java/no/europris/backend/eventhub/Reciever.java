...
public class Reciever {
    ...
    private void processEvent(EventData event) {
        try{
        //For å unngå og opprette Java-objekter bruker vi JsonNode som lar oss jobbe dynamisk med Json-data.
        ...
        //Legger til kategori basert på verdien i feltet, verdiene skal endres i etterkant

        if (jsonNode.get("receiptTotalIncVat").asDouble() >= 300 && jsonNode.get("receiptTotalIncVat").asDouble() < 800) {
 ...
 * https://www.baeldung.com/jackson-json-node-tree-model?utm_source=chatgpt.com
 */